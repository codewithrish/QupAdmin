package app.qup.summary.data.remote.dto.general

import app.qup.summary.domain.model.DailySummaryReport

data class DailySummaryReportResource(
...
fun DailySummaryReportResource.toDailySummaryReport(): DailySummaryReport {
