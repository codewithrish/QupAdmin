package com.codewithrish.entity_management.data.paging
...
class GetAllEntitiesPagingData @Inject constructor(
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, EntityResource> {
        return try {
            ...
            val response = entityApi.getAllEntities(position, size).body()
